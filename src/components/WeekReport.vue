...
export default {
  ...
  methods: {
    show(index) {
      this.axios
        .post(
          "http://10.1.6.241:9200/daily/weeklyinfo/findByUserId",
          qs.stringify({
    ...
    timeSearch() {
      ...
      this.axios.post('http://10.1.6.241:9200/daily/dailyinfo/findByUserIdAndDate',
            qs.stringify(
                {
    ...
    ontPut: function() {
      var myHerf =
        "http://10.1.6.241:9200/daily/weeklyinfo/export?userId=" +
        this.$store.user +
        "&dateFrom=" +
        this.$data.dateFrom +
        "&dateTo=" +
  ...
  mounted() {
    ...
    this.axios
      .post(
        "http://10.1.6.241:9200/daily/weeklyinfo/showWeeklyInfo",
        qs.stringify({
          userId: this.$store.user
        })
      )
