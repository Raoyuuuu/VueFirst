...
var myId
        ...
        methods: {
            ...
            ok(){
             ...
             var params={
              ...
              this.axios.post("http://10.1.6.241:9200/daily/roleinfo/saveRoleAndPowers",params).then(res =>{
    ...
    mounted(){
            var myToken = window.localStorage.getItem('token')
            this.axios.defaults.headers.common['kt-token'] =myToken
            this.axios.post('http://10.1.6.241:9200/daily/roleinfo/findAllRolesAndPowers')
            .then(res => {
                if(res.data.resultCode == '200'){
