    ...
    export default {
        ...
        methods: {
            edit (index) {
                ...
                this.axios.post('http://10.1.6.241:9200/daily/dailyinfo/findByDailyId',
                qs.stringify({
            ...
            remove (index) {
                ...
                console.log(thisDId)
                this.axios.post('http://10.1.6.241:9200/daily/dailyinfo/delByDailyId',
                    qs.stringify({
                        dailyId: thisDId
                    })
                )
            ...
            ok () {
                ...
                this.axios.post('http://10.1.6.241:9200/daily/dailyinfo/updateByDailyId',
                qs.stringify({
            ...
            this.axios.post('http://10.1.6.241:9200/daily/dailyinfo/save',
                qs.stringify({
                    userId:userId,
            ...
            this.axios.defaults.headers.common['tk-token'] = myToken
             this.axios.post('http://10.1.6.241:9200/daily/dailyinfo/findByUserId',qs.stringify({
            userId:userId
            }))
            .then(res => {
            console.log(res)
